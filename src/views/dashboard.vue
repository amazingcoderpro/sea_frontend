    ...
    <div class="dashboard">
        ...
        <div class="table_right MB10">
          <el-table :data="tableData" border ref="topictable">
            ...
            <el-table-column  align="center"  class="parentNodeColumn" prop="sales_num" label="Transactions"  width="208"></el-table-column>
            <el-table-column  align="center"  class="parentNodeColumn" prop="revenue_num" label="Revenue" width="208"></el-table-column>
          </el-table>
        </div>
        <div class="bottomBox">
            <div class="leftBox">
